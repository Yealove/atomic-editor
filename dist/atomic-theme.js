...
export const atomicEditorTheme = EditorView.theme({
    '&': {
    ...
    '.cm-searchMatch': {
        backgroundColor: 'var(--atomic-editor-search-bg, color-mix(in srgb, #7c3aed 26%, transparent 74%))',
        borderRadius: '2px',
    },
    '.cm-searchMatch.cm-searchMatch-selected': {
        backgroundColor: 'var(--atomic-editor-search-bg-active, color-mix(in srgb, #7c3aed 60%, transparent 40%))',
...
//# sourceMappingURL=atomic-theme.js.map