import { defineComponent, h, ref, shallowRef, watch, onMounted, onBeforeUnmount, } from 'vue';
...
export const AtomicCodeMirrorEditor = defineComponent({
    ...
    setup(props) {
        ...
        const onMarkdownChange = () => props.onMarkdownChange;
        const onLinkClick = () => props.onLinkClick;
        const imageSrcResolver = () => props.imageSrcResolver;
        onMounted(() => {
            ...
            const view = new EditorView({
                ...
                state: EditorState.create({
                    ...
                    extensions: [
                        ...
                        markdown({ base: markdownLanguage, codeLanguages: [...props.codeLanguages] }),
        ...
        watch(() => props.editorHandleRef, () => publishHandle());
        watch(() => props.initialRevealText, (text) => {
            if (text && viewRef.value) {
                revealInitialMatch(viewRef.value, text);
            }
        });
        function revealInitialMatch(view, queryText) {
