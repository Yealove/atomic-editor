...
function linkIconHitTarget(event, root) {
    ...
    const onIcon = event.clientX >= lastRect.right - iconZone &&
...
function insertTightListItem(view) {
    const { state } = view;
